...
It contains the same opcodes as the [bitcoin-inquisition](https://github.com/bitcoin-inquisition/bitcoin) repo (which already includes `OP_CHECKTEMPLATEVERIFY`,  `OP_CHECKSIGFROMSTACK`, `OP_INTERNALKEY`, `OP_CAT`), plus the `OP_CHECKCONTRACTVERIFY` opcode.
